  ...
  <SlideFrame>
    ...
    <div className="mt-8 grid flex-1 grid-cols-[0.9fr_1.1fr] items-center gap-8">
      <Panel className="flex h-full flex-col justify-center p-7">
        ...
        <p className="mt-5 font-mono text-2xl text-text">seed + solutionID → rand.Rand</p>
      ...
      <div className="space-y-4">
        <Reveal visible={step >= 0} preserveLayout>
          <div className="flex items-center gap-4">
            <div className="w-36 rounded-2xl border-2 border-primary bg-primary/10 px-4 py-4 text-center font-mono text-lg font-bold text-text">jobs<br /><span className="text-primary">solution IDs</span></div>
